...
class ResConfigSettings(models.TransientModel):
    ...
    sale_count = fields.Integer(
        string='How many recent sale records do you want to show?',
    ...
    purchase_count = fields.Integer(
        string='How many recent purchase records do you want to show?',
    ...
    project_count = fields.Integer(
        string='How many recent project records do you want to show?',
    ...
    account_count = fields.Integer(
        string='How many recent account records do you want to show?',
