...

{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            '/theme_archit/static/src/css/owl.theme.default.min.css',
            '/theme_archit/static/src/css/style.css',
            'https://fonts.loli.net/css2?family=Poppins&amp;family=Space+Mono:ital,wght@0,400;0,700;1,400&amp;family=Work+Sans&amp;display=swap',
            'https://fonts.loli.net/css2?family=Overpass+Mono:wght@700&amp;display=swap',
            'https://fonts.loli.net/css2?family=Julius+Sans+One&amp;display=swap',
